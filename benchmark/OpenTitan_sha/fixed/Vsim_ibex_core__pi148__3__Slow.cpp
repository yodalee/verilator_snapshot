...
VL_ATTR_COLD void Vsim_ibex_core__pi148___stl_sequent__TOP__chip_sim_tb__DOT__u_dut__DOT__top_earlgrey__DOT__u_rv_core_ibex__DOT__u_core__DOT__gen_lockstep__DOT__u_ibex_lockstep__DOT__u_shadow_core__1(Vsim_ibex_core__pi148* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vsim_ibex_core__pi148___stl_sequent__TOP__chip_sim_tb__DOT__u_dut__DOT__top_earlgrey__DOT__u_rv_core_ibex__DOT__u_core__DOT__gen_lockstep__DOT__u_ibex_lockstep__DOT__u_shadow_core__1\n"); );
                                        ...
                                        ((1U & (IData)(vlSelfRef.__PVT__ex_block_i__DOT__gen_multdiv_fast__DOT__multdiv_i__DOT__md_state_q))
                                          ? 2U : ((2U 
                                                  ...
                                                  (((~ 
                                                    ...
                                                    ? 6U
                                                    : 1U)))));
    vlSelfRef.__PVT__rvfi_mem_addr_d = ((IData)(vlSelfRef.__PVT__ex_block_i__DOT__alu_i__DOT__instr_first_cycle_i)
                                         ? (IData)(
                                                   (vlSelfRef.__PVT__ex_block_i__DOT__alu_i__DOT__adder_result_ext_o 
                                                    >> 1U))
                                         : vlSelfRef.__PVT__rvfi_mem_addr_q);
