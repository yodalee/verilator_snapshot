...
VL_ATTR_COLD void Vsim_prim_subreg_shadow__pi124___ctor_var_reset(Vsim_prim_subreg_shadow__pi124* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vsim_prim_subreg_shadow__pi124___ctor_var_reset\n"); );
