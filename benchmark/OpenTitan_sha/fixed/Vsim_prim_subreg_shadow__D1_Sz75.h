...
#ifndef VERILATED_VSIM_PRIM_SUBREG_SHADOW__D1_SZ75_H_
#define VERILATED_VSIM_PRIM_SUBREG_SHADOW__D1_SZ75_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vsim_prim_subreg_shadow__D1_Sz75 final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vsim_prim_subreg_shadow__D1_Sz75(Vsim__Syms* symsp, const char* v__name);
    ~Vsim_prim_subreg_shadow__D1_Sz75();
    VL_UNCOPYABLE(Vsim_prim_subreg_shadow__D1_Sz75);
