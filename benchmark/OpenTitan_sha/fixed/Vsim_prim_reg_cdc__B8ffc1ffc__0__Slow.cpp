...
VL_ATTR_COLD void Vsim_prim_reg_cdc__B8ffc1ffc___stl_sequent__TOP__chip_sim_tb__DOT__u_dut__DOT__top_earlgrey__DOT__u_adc_ctrl_aon__DOT__u_reg__DOT__u_adc_chn0_filter_ctl_0_cdc__0(Vsim_prim_reg_cdc__B8ffc1ffc* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vsim_prim_reg_cdc__B8ffc1ffc___stl_sequent__TOP__chip_sim_tb__DOT__u_dut__DOT__top_earlgrey__DOT__u_adc_ctrl_aon__DOT__u_reg__DOT__u_adc_chn0_filter_ctl_0_cdc__0\n"); );
...
VL_ATTR_COLD void Vsim_prim_reg_cdc__B8ffc1ffc___ctor_var_reset(Vsim_prim_reg_cdc__B8ffc1ffc* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vsim_prim_reg_cdc__B8ffc1ffc___ctor_var_reset\n"); );
    Vsim__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    vlSelf->__PVT__dst_regwen_o = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 4157798524948868598ull);
