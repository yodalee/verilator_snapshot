...
#ifndef VERILATED_VSIM_PRIM_ALERT_SENDER_H_
#define VERILATED_VSIM_PRIM_ALERT_SENDER_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vsim_prim_alert_sender final : public VerilatedModule {
  public:
    // CELLS
    ...
    // CONSTRUCTORS
    Vsim_prim_alert_sender(Vsim__Syms* symsp, const char* v__name);
    ~Vsim_prim_alert_sender();
    VL_UNCOPYABLE(Vsim_prim_alert_sender);
