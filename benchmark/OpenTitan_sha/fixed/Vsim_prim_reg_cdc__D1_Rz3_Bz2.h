...
#ifndef VERILATED_VSIM_PRIM_REG_CDC__D1_RZ3_BZ2_H_
#define VERILATED_VSIM_PRIM_REG_CDC__D1_RZ3_BZ2_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vsim_prim_reg_cdc__D1_Rz3_Bz2 final : public VerilatedModule {
  public:
    // CELLS
    ...
    // CONSTRUCTORS
    Vsim_prim_reg_cdc__D1_Rz3_Bz2(Vsim__Syms* symsp, const char* v__name);
    ~Vsim_prim_reg_cdc__D1_Rz3_Bz2();
    VL_UNCOPYABLE(Vsim_prim_reg_cdc__D1_Rz3_Bz2);
