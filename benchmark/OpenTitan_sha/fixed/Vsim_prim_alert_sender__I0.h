...
#ifndef VERILATED_VSIM_PRIM_ALERT_SENDER__I0_H_
#define VERILATED_VSIM_PRIM_ALERT_SENDER__I0_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vsim_prim_alert_sender__I0 final : public VerilatedModule {
  public:
    // CELLS
    ...
    CData/*0:0*/ __PVT__alert_req_trigger;
    ...
    // CONSTRUCTORS
    Vsim_prim_alert_sender__I0(Vsim__Syms* symsp, const char* v__name);
    ~Vsim_prim_alert_sender__I0();
    VL_UNCOPYABLE(Vsim_prim_alert_sender__I0);
