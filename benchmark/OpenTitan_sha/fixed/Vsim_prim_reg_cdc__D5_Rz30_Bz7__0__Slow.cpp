...
VL_ATTR_COLD void Vsim_prim_reg_cdc__D5_Rz30_Bz7___stl_sequent__TOP__chip_sim_tb__DOT__u_dut__DOT__top_earlgrey__DOT__u_sysrst_ctrl_aon__DOT__u_reg__DOT__u_com_pre_sel_ctl_0_cdc__0(Vsim_prim_reg_cdc__D5_Rz30_Bz7* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vsim_prim_reg_cdc__D5_Rz30_Bz7___stl_sequent__TOP__chip_sim_tb__DOT__u_dut__DOT__top_earlgrey__DOT__u_sysrst_ctrl_aon__DOT__u_reg__DOT__u_com_pre_sel_ctl_0_cdc__0\n"); );
...
VL_ATTR_COLD void Vsim_prim_reg_cdc__D5_Rz30_Bz7___ctor_var_reset(Vsim_prim_reg_cdc__D5_Rz30_Bz7* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vsim_prim_reg_cdc__D5_Rz30_Bz7___ctor_var_reset\n"); );
    Vsim__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    vlSelf->src_wd_i = VL_SCOPED_RAND_RESET_I(5, __VscopeHash, 14796056282611505485ull);
    vlSelf->src_busy_o = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 10086578303772526111ull);
    vlSelf->src_qs_o = VL_SCOPED_RAND_RESET_I(5, __VscopeHash, 7303931147743945635ull);
    vlSelf->dst_ds_i = VL_SCOPED_RAND_RESET_I(5, __VscopeHash, 8570661034182711617ull);
    vlSelf->dst_qs_i = VL_SCOPED_RAND_RESET_I(5, __VscopeHash, 1188878227332427069ull);
    ...
    vlSelf->dst_wd_o = VL_SCOPED_RAND_RESET_I(5, __VscopeHash, 5097451175198061258ull);
    ...
    vlSelf->__PVT__src_q = VL_SCOPED_RAND_RESET_I(5, __VscopeHash, 13948712467904634369ull);
