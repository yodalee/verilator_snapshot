...
VL_ATTR_COLD void Vsim_prim_subreg_shadow__D1_Sz75___stl_sequent__TOP__chip_sim_tb__DOT__u_dut__DOT__top_earlgrey__DOT__u_aes__DOT__u_reg__DOT__u_ctrl_aux_shadowed_force_masks__0(Vsim_prim_subreg_shadow__D1_Sz75* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vsim_prim_subreg_shadow__D1_Sz75___stl_sequent__TOP__chip_sim_tb__DOT__u_dut__DOT__top_earlgrey__DOT__u_aes__DOT__u_reg__DOT__u_ctrl_aux_shadowed_force_masks__0\n"); );
...
VL_ATTR_COLD void Vsim_prim_subreg_shadow__D1_Sz75___ctor_var_reset(Vsim_prim_subreg_shadow__D1_Sz75* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vsim_prim_subreg_shadow__D1_Sz75___ctor_var_reset\n"); );
    Vsim__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    vlSelf->wd = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 18210509495843279068ull);
    ...
    vlSelf->__PVT__ds = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 10343076919720641053ull);
    vlSelf->qs = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 1373413353089790568ull);
    ...
    vlSelf->__PVT__staged_q = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 5239208138423617019ull);
    vlSelf->__PVT__shadow_q = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 2866240867468553813ull);
    vlSelf->__PVT__committed_q = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 1452413327363196313ull);
    ...
    vlSelf->__PVT__committed_reg__DOT__wd = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 14452529580513763902ull);
}
