...
#ifndef VERILATED_VSIM_PRIM_REG_CDC_H_
#define VERILATED_VSIM_PRIM_REG_CDC_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vsim_prim_reg_cdc final : public VerilatedModule {
  public:
    // CELLS
    ...
    // CONSTRUCTORS
    Vsim_prim_reg_cdc(Vsim__Syms* symsp, const char* v__name);
    ~Vsim_prim_reg_cdc();
    VL_UNCOPYABLE(Vsim_prim_reg_cdc);
