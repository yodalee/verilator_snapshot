...
#ifndef VERILATED_VSIM_RSTMGR_LEAF_RST__SZ5_SCZ3_H_
#define VERILATED_VSIM_RSTMGR_LEAF_RST__SZ5_SCZ3_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vsim_rstmgr_leaf_rst__Sz5_SCz3 final : public VerilatedModule {
  public:
    // CELLS
    ...
    // CONSTRUCTORS
    Vsim_rstmgr_leaf_rst__Sz5_SCz3(Vsim__Syms* symsp, const char* v__name);
    ~Vsim_rstmgr_leaf_rst__Sz5_SCz3();
    VL_UNCOPYABLE(Vsim_rstmgr_leaf_rst__Sz5_SCz3);
