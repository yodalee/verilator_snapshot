...
#ifndef VERILATED_VSIM_PRIM_REG_CDC__B8FFC1FFC_H_
#define VERILATED_VSIM_PRIM_REG_CDC__B8FFC1FFC_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vsim_prim_reg_cdc__B8ffc1ffc final : public VerilatedModule {
  public:
    // CELLS
    ...
    VL_OUT8(__PVT__dst_regwen_o,0,0);
    ...
    IData/*31:0*/ __PVT__src_q;

    // INTERNAL VARIABLES
    Vsim__Syms* const vlSymsp;

    // CONSTRUCTORS
    Vsim_prim_reg_cdc__B8ffc1ffc(Vsim__Syms* symsp, const char* v__name);
    ~Vsim_prim_reg_cdc__B8ffc1ffc();
    VL_UNCOPYABLE(Vsim_prim_reg_cdc__B8ffc1ffc);
