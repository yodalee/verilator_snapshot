...
VL_ATTR_COLD void Vsim_prim_lc_sync__N2___ctor_var_reset(Vsim_prim_lc_sync__N2* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vsim_prim_lc_sync__N2___ctor_var_reset\n"); );
    ...
    vlSelf->lc_en_o = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 16343096869173629824ull);
