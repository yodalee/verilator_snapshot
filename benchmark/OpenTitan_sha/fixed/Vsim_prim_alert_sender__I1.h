...
#ifndef VERILATED_VSIM_PRIM_ALERT_SENDER__I1_H_
#define VERILATED_VSIM_PRIM_ALERT_SENDER__I1_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vsim_prim_alert_sender__I1 final : public VerilatedModule {
  public:
    // CELLS
    ...
    CData/*0:0*/ __VdfgRegularize_h6e95ff9d_0_1707;

    // INTERNAL VARIABLES
    Vsim__Syms* const vlSymsp;

    // CONSTRUCTORS
    Vsim_prim_alert_sender__I1(Vsim__Syms* symsp, const char* v__name);
    ~Vsim_prim_alert_sender__I1();
    VL_UNCOPYABLE(Vsim_prim_alert_sender__I1);
