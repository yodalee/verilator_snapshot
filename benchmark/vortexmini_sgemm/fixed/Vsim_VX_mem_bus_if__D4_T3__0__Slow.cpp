...
VL_ATTR_COLD void Vsim_VX_mem_bus_if__D4_T3___ctor_var_reset(Vsim_VX_mem_bus_if__D4_T3* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                      Vsim_VX_mem_bus_if__D4_T3___ctor_var_reset\n"); );
