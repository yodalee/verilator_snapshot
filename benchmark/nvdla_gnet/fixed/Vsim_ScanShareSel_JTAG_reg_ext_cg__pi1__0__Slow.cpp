...
VL_ATTR_COLD void Vsim_ScanShareSel_JTAG_reg_ext_cg__pi1___ctor_var_reset(Vsim_ScanShareSel_JTAG_reg_ext_cg__pi1* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                            Vsim_ScanShareSel_JTAG_reg_ext_cg__pi1___ctor_var_reset\n"); );
