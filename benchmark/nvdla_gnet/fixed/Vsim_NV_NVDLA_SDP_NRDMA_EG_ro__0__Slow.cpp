...
VL_ATTR_COLD void Vsim_NV_NVDLA_SDP_NRDMA_EG_ro___stl_sequent__TOP__tb_top__DOT__nvdla_top__DOT__u_partition_p__DOT__u_NV_NVDLA_sdp__DOT__u_rdma__DOT__u_nrdma__DOT__u_eg__DOT__u_alu__0(Vsim_NV_NVDLA_SDP_NRDMA_EG_ro* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                    Vsim_NV_NVDLA_SDP_NRDMA_EG_ro___stl_sequent__TOP__tb_top__DOT__nvdla_top__DOT__u_partition_p__DOT__u_NV_NVDLA_sdp__DOT__u_rdma__DOT__u_nrdma__DOT__u_eg__DOT__u_alu__0\n"); );
...
VL_ATTR_COLD void Vsim_NV_NVDLA_SDP_NRDMA_EG_ro___stl_sequent__TOP__tb_top__DOT__nvdla_top__DOT__u_partition_p__DOT__u_NV_NVDLA_sdp__DOT__u_rdma__DOT__u_nrdma__DOT__u_eg__DOT__u_alu__1(Vsim_NV_NVDLA_SDP_NRDMA_EG_ro* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                    Vsim_NV_NVDLA_SDP_NRDMA_EG_ro___stl_sequent__TOP__tb_top__DOT__nvdla_top__DOT__u_partition_p__DOT__u_NV_NVDLA_sdp__DOT__u_rdma__DOT__u_nrdma__DOT__u_eg__DOT__u_alu__1\n"); );
    Vsim__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vsim_NV_NVDLA_SDP_NRDMA_EG_ro___stl_sequent__TOP__tb_top__DOT__nvdla_top__DOT__u_partition_p__DOT__u_NV_NVDLA_sdp__DOT__u_rdma__DOT__u_nrdma__DOT__u_eg__DOT__u_mul__0(Vsim_NV_NVDLA_SDP_NRDMA_EG_ro* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                    Vsim_NV_NVDLA_SDP_NRDMA_EG_ro___stl_sequent__TOP__tb_top__DOT__nvdla_top__DOT__u_partition_p__DOT__u_NV_NVDLA_sdp__DOT__u_rdma__DOT__u_nrdma__DOT__u_eg__DOT__u_mul__0\n"); );
    Vsim__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__u_roc__DOT__rd_adr_next_popping 
...
VL_ATTR_COLD void Vsim_NV_NVDLA_SDP_NRDMA_EG_ro___stl_sequent__TOP__tb_top__DOT__nvdla_top__DOT__u_partition_p__DOT__u_NV_NVDLA_sdp__DOT__u_rdma__DOT__u_nrdma__DOT__u_eg__DOT__u_mul__1(Vsim_NV_NVDLA_SDP_NRDMA_EG_ro* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                    Vsim_NV_NVDLA_SDP_NRDMA_EG_ro___stl_sequent__TOP__tb_top__DOT__nvdla_top__DOT__u_partition_p__DOT__u_NV_NVDLA_sdp__DOT__u_rdma__DOT__u_nrdma__DOT__u_eg__DOT__u_mul__1\n"); );
    Vsim__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__u_roc__DOT__wr_reserving = ((~ (IData)(vlSelfRef.__PVT__u_roc__DOT__roc_wr_busy_int)) 
...
VL_ATTR_COLD void Vsim_NV_NVDLA_SDP_NRDMA_EG_ro___ctor_var_reset(Vsim_NV_NVDLA_SDP_NRDMA_EG_ro* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                    Vsim_NV_NVDLA_SDP_NRDMA_EG_ro___ctor_var_reset\n"); );
    Vsim__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    vlSelf->sdp_nrdma2dp_ready = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 17392466433881314920ull);
    ...
    VL_SCOPED_RAND_RESET_W(257, vlSelf->sdp_nrdma2dp_pd, __VscopeHash, 3081979200103067042ull);
    vlSelf->sdp_nrdma2dp_valid = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 8898052970776605047ull);
    ...
    vlSelf->__VdfgRegularize_h59bf5ad5_0_0 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 17733540931332741929ull);
    vlSelf->__VdfgRegularize_h59bf5ad5_0_1 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 4178019439207664468ull);
    ...
    vlSelf->u_rod0__DOT____VdfgRegularize_h200784cc_0_1 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 13616382167808810079ull);
    vlSelf->u_rod0__DOT____VdfgRegularize_h200784cc_0_2 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 7771685195617989920ull);
    ...
    vlSelf->u_rod1__DOT____VdfgRegularize_h200784cc_0_1 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 4770505101246191871ull);
    vlSelf->u_rod1__DOT____VdfgRegularize_h200784cc_0_2 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 11797039839966819852ull);
    ...
    vlSelf->u_rod2__DOT____VdfgRegularize_h200784cc_0_1 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 15555877795240797363ull);
    vlSelf->u_rod2__DOT____VdfgRegularize_h200784cc_0_2 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 2486423357776292815ull);
    ...
    vlSelf->u_rod3__DOT____VdfgRegularize_h200784cc_0_1 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 7433260344709433574ull);
    vlSelf->u_rod3__DOT____VdfgRegularize_h200784cc_0_2 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 15334695980025455672ull);
    ...
    vlSelf->u_roc__DOT____VdfgRegularize_h16554141_0_1 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 1862430311474051123ull);
    vlSelf->u_roc__DOT____VdfgRegularize_h16554141_0_3 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 421002111762027442ull);
    ...
    vlSelf->__VdfgRegularize_h6e95ff9d_0_3098 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 4287871842431530006ull);
    vlSelf->__VdfgRegularize_h6e95ff9d_0_3103 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 12941018851114537796ull);
    vlSelf->__VdfgRegularize_h6e95ff9d_0_3483 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 13617098260084253592ull);
    vlSelf->__VdfgRegularize_h6e95ff9d_0_3486 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 10159007117065291595ull);
