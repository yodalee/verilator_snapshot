...
VL_ATTR_COLD void Vsim_ScanShareSel_JTAG_reg_ext_cg__pi7___ctor_var_reset(Vsim_ScanShareSel_JTAG_reg_ext_cg__pi7* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                            Vsim_ScanShareSel_JTAG_reg_ext_cg__pi7___ctor_var_reset\n"); );
    Vsim__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    const uint64_t __VscopeHash = VL_MURMUR64_HASH(vlSelf->name());
    vlSelf->D = VL_SCOPED_RAND_RESET_I(5, __VscopeHash, 9391737413944127320ull);
    ...
    vlSelf->Q = VL_SCOPED_RAND_RESET_I(5, __VscopeHash, 17714545831559622561ull);
