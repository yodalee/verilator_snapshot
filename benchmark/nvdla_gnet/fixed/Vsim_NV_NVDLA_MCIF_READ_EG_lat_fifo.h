...
#ifndef VERILATED_VSIM_NV_NVDLA_MCIF_READ_EG_LAT_FIFO_H_
#define VERILATED_VSIM_NV_NVDLA_MCIF_READ_EG_LAT_FIFO_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vsim_NV_NVDLA_MCIF_READ_EG_lat_fifo final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vsim_NV_NVDLA_MCIF_READ_EG_lat_fifo(Vsim__Syms* symsp, const char* v__name);
    ~Vsim_NV_NVDLA_MCIF_READ_EG_lat_fifo();
    VL_UNCOPYABLE(Vsim_NV_NVDLA_MCIF_READ_EG_lat_fifo);
