...
VL_ATTR_COLD void Vsim_NV_NVDLA_SDP_BRDMA_EG_ro___stl_sequent__TOP__tb_top__DOT__nvdla_top__DOT__u_partition_p__DOT__u_NV_NVDLA_sdp__DOT__u_rdma__DOT__u_brdma__DOT__u_eg__DOT__u_alu__0(Vsim_NV_NVDLA_SDP_BRDMA_EG_ro* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                    Vsim_NV_NVDLA_SDP_BRDMA_EG_ro___stl_sequent__TOP__tb_top__DOT__nvdla_top__DOT__u_partition_p__DOT__u_NV_NVDLA_sdp__DOT__u_rdma__DOT__u_brdma__DOT__u_eg__DOT__u_alu__0\n"); );
...
VL_ATTR_COLD void Vsim_NV_NVDLA_SDP_BRDMA_EG_ro___stl_sequent__TOP__tb_top__DOT__nvdla_top__DOT__u_partition_p__DOT__u_NV_NVDLA_sdp__DOT__u_rdma__DOT__u_brdma__DOT__u_eg__DOT__u_alu__1(Vsim_NV_NVDLA_SDP_BRDMA_EG_ro* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                    Vsim_NV_NVDLA_SDP_BRDMA_EG_ro___stl_sequent__TOP__tb_top__DOT__nvdla_top__DOT__u_partition_p__DOT__u_NV_NVDLA_sdp__DOT__u_rdma__DOT__u_brdma__DOT__u_eg__DOT__u_alu__1\n"); );
    Vsim__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    if (vlSymsp->TOP.tb_top__DOT__nvdla_top__DOT__u_partition_p__DOT__u_NV_NVDLA_sdp__DOT__u_rdma__DOT__u_brdma__DOT__u_eg__DOT__need_extra_rod) {
        vlSelfRef.__VdfgRegularize_h6e95ff9d_0_576 
            = ((IData)(vlSymsp->TOP.tb_top__DOT__nvdla_top__DOT__u_partition_p__DOT__u_NV_NVDLA_sdp__DOT__u_rdma__DOT__u_brdma__DOT__u_eg__DOT__is_last_beat)
                ? 1U : 3U);
        vlSelfRef.__VdfgRegularize_h6e95ff9d_0_578 
            = ((IData)(vlSymsp->TOP.tb_top__DOT__nvdla_top__DOT__u_partition_p__DOT__u_NV_NVDLA_sdp__DOT__u_rdma__DOT__u_nrdma__DOT__u_eg__DOT__is_last_beat)
                ? 1U : 3U);
        vlSelfRef.__VdfgRegularize_h6e95ff9d_0_580 
            = ((IData)(vlSymsp->TOP.tb_top__DOT__nvdla_top__DOT__u_partition_p__DOT__u_NV_NVDLA_sdp__DOT__u_rdma__DOT__u_erdma__DOT__u_eg__DOT__is_last_beat)
                ? 1U : 3U);
    } else if ((0U == (IData)(vlSymsp->TOP.tb_top__DOT__nvdla_top__DOT__u_partition_p__DOT__u_NV_NVDLA_sdp__DOT__u_rdma__DOT__u_brdma__DOT__u_eg__DOT__reg2dp_proc_precision))) {
        vlSelfRef.__VdfgRegularize_h6e95ff9d_0_576 = 0U;
        vlSelfRef.__VdfgRegularize_h6e95ff9d_0_578 = 0U;
        vlSelfRef.__VdfgRegularize_h6e95ff9d_0_580 = 0U;
    } else {
        vlSelfRef.__VdfgRegularize_h6e95ff9d_0_576 
...
VL_ATTR_COLD void Vsim_NV_NVDLA_SDP_BRDMA_EG_ro___stl_sequent__TOP__tb_top__DOT__nvdla_top__DOT__u_partition_p__DOT__u_NV_NVDLA_sdp__DOT__u_rdma__DOT__u_brdma__DOT__u_eg__DOT__u_mul__0(Vsim_NV_NVDLA_SDP_BRDMA_EG_ro* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                    Vsim_NV_NVDLA_SDP_BRDMA_EG_ro___stl_sequent__TOP__tb_top__DOT__nvdla_top__DOT__u_partition_p__DOT__u_NV_NVDLA_sdp__DOT__u_rdma__DOT__u_brdma__DOT__u_eg__DOT__u_mul__0\n"); );
    Vsim__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__u_roc__DOT__rd_adr_next_popping 
...
VL_ATTR_COLD void Vsim_NV_NVDLA_SDP_BRDMA_EG_ro___stl_sequent__TOP__tb_top__DOT__nvdla_top__DOT__u_partition_p__DOT__u_NV_NVDLA_sdp__DOT__u_rdma__DOT__u_brdma__DOT__u_eg__DOT__u_mul__1(Vsim_NV_NVDLA_SDP_BRDMA_EG_ro* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                    Vsim_NV_NVDLA_SDP_BRDMA_EG_ro___stl_sequent__TOP__tb_top__DOT__nvdla_top__DOT__u_partition_p__DOT__u_NV_NVDLA_sdp__DOT__u_rdma__DOT__u_brdma__DOT__u_eg__DOT__u_mul__1\n"); );
    Vsim__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vsim_NV_NVDLA_SDP_BRDMA_EG_ro___ctor_var_reset(Vsim_NV_NVDLA_SDP_BRDMA_EG_ro* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                    Vsim_NV_NVDLA_SDP_BRDMA_EG_ro___ctor_var_reset\n"); );
    Vsim__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    vlSelf->sdp_brdma2dp_ready = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 3649293390160420066ull);
    ...
    VL_SCOPED_RAND_RESET_W(257, vlSelf->sdp_brdma2dp_pd, __VscopeHash, 7463442089287264339ull);
    vlSelf->sdp_brdma2dp_valid = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 6017564693861835375ull);
    ...
    vlSelf->__PVT__size_of_step = VL_SCOPED_RAND_RESET_I(2, __VscopeHash, 13155387564449538377ull);
    ...
    vlSelf->__PVT__size_of_surf = VL_SCOPED_RAND_RESET_I(9, __VscopeHash, 4845679383045731797ull);
    vlSelf->__VdfgRegularize_he389c3cf_0_0 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 10637935813904987859ull);
    vlSelf->__VdfgRegularize_he389c3cf_0_1 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 8968019824951843704ull);
    ...
    vlSelf->u_rod0__DOT____VdfgRegularize_hae7466ad_0_1 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 3205659203027041140ull);
    vlSelf->u_rod0__DOT____VdfgRegularize_hae7466ad_0_2 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 13941560231414120693ull);
    ...
    vlSelf->u_rod1__DOT____VdfgRegularize_hae7466ad_0_1 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 11213557410183122844ull);
    vlSelf->u_rod1__DOT____VdfgRegularize_hae7466ad_0_2 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 439354820544743988ull);
    ...
    vlSelf->u_rod2__DOT____VdfgRegularize_hae7466ad_0_1 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 576792453872815198ull);
    vlSelf->u_rod2__DOT____VdfgRegularize_hae7466ad_0_2 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 17679647774005274192ull);
    ...
    vlSelf->u_rod3__DOT____VdfgRegularize_hae7466ad_0_1 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 2712646819641193894ull);
    vlSelf->u_rod3__DOT____VdfgRegularize_hae7466ad_0_2 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 2280701376696365805ull);
    ...
    vlSelf->u_roc__DOT____VdfgRegularize_hd55967b3_0_1 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 1523083325653415807ull);
    vlSelf->u_roc__DOT____VdfgRegularize_hd55967b3_0_3 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 12810179112417634255ull);
    ...
    vlSelf->__VdfgRegularize_h6e95ff9d_0_576 = VL_SCOPED_RAND_RESET_I(2, __VscopeHash, 1579786404626603511ull);
    vlSelf->__VdfgRegularize_h6e95ff9d_0_578 = VL_SCOPED_RAND_RESET_I(2, __VscopeHash, 1587846986493905776ull);
    vlSelf->__VdfgRegularize_h6e95ff9d_0_580 = VL_SCOPED_RAND_RESET_I(2, __VscopeHash, 2065856328243694ull);
    vlSelf->__VdfgRegularize_h6e95ff9d_0_3076 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 7274372071286158774ull);
    vlSelf->__VdfgRegularize_h6e95ff9d_0_3083 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 4077838171253478011ull);
    vlSelf->__VdfgRegularize_h6e95ff9d_0_3495 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 8129708008970957648ull);
    vlSelf->__VdfgRegularize_h6e95ff9d_0_3498 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 2983906720246279331ull);
