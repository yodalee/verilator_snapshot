...
#ifndef VERILATED_VSIM_NV_NVDLA_CDP_WDMA_DAT_FIFO_H_
#define VERILATED_VSIM_NV_NVDLA_CDP_WDMA_DAT_FIFO_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vsim_NV_NVDLA_CDP_WDMA_dat_fifo final : public VerilatedModule {
  public:
    ...
    CData/*0:0*/ __VdfgRegularize_hd468d6ca_0_2;
    ...
    // CONSTRUCTORS
    Vsim_NV_NVDLA_CDP_WDMA_dat_fifo(Vsim__Syms* symsp, const char* v__name);
    ~Vsim_NV_NVDLA_CDP_WDMA_dat_fifo();
    VL_UNCOPYABLE(Vsim_NV_NVDLA_CDP_WDMA_dat_fifo);
