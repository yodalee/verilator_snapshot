...
VL_ATTR_COLD void Vsim_NV_NVDLA_CMAC_CORE_MAC_mul___stl_sequent__TOP__tb_top__DOT__nvdla_top__DOT__u_partition_ma__u_NV_NVDLA_cmac__DOT__u_core__DOT__u_mac_3__u_mul_0__0(Vsim_NV_NVDLA_CMAC_CORE_MAC_mul* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vsim_NV_NVDLA_CMAC_CORE_MAC_mul___stl_sequent__TOP__tb_top__DOT__nvdla_top__DOT__u_partition_ma__u_NV_NVDLA_cmac__DOT__u_core__DOT__u_mac_3__u_mul_0__0\n"); );
...
VL_ATTR_COLD void Vsim_NV_NVDLA_CMAC_CORE_MAC_mul___stl_sequent__TOP__tb_top__DOT__nvdla_top__DOT__u_partition_ma__u_NV_NVDLA_cmac__DOT__u_core__DOT__u_mac_3__u_mul_1__0(Vsim_NV_NVDLA_CMAC_CORE_MAC_mul* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vsim_NV_NVDLA_CMAC_CORE_MAC_mul___stl_sequent__TOP__tb_top__DOT__nvdla_top__DOT__u_partition_ma__u_NV_NVDLA_cmac__DOT__u_core__DOT__u_mac_3__u_mul_1__0\n"); );
    Vsim__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
    CData/*0:0*/ u_tree_l0n0__DOT____Vlvbound_h1cadd727__0;
...
VL_ATTR_COLD void Vsim_NV_NVDLA_CMAC_CORE_MAC_mul___stl_sequent__TOP__tb_top__DOT__nvdla_top__DOT__u_partition_ma__u_NV_NVDLA_cmac__DOT__u_core__DOT__u_mac_3__u_mul_2__0(Vsim_NV_NVDLA_CMAC_CORE_MAC_mul* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vsim_NV_NVDLA_CMAC_CORE_MAC_mul___stl_sequent__TOP__tb_top__DOT__nvdla_top__DOT__u_partition_ma__u_NV_NVDLA_cmac__DOT__u_core__DOT__u_mac_3__u_mul_2__0\n"); );
    Vsim__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
    CData/*0:0*/ u_tree_l0n0__DOT____Vlvbound_h1cadd727__0;
