...
#ifndef VERILATED_VSIM_NV_NVDLA_CVIF_WRITE_IG_ARB_DFIFO_H_
#define VERILATED_VSIM_NV_NVDLA_CVIF_WRITE_IG_ARB_DFIFO_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vsim_NV_NVDLA_CVIF_WRITE_IG_ARB_dfifo final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vsim_NV_NVDLA_CVIF_WRITE_IG_ARB_dfifo(Vsim__Syms* symsp, const char* v__name);
    ~Vsim_NV_NVDLA_CVIF_WRITE_IG_ARB_dfifo();
    VL_UNCOPYABLE(Vsim_NV_NVDLA_CVIF_WRITE_IG_ARB_dfifo);
