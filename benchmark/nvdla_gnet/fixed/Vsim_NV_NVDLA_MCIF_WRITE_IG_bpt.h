...
#ifndef VERILATED_VSIM_NV_NVDLA_MCIF_WRITE_IG_BPT_H_
#define VERILATED_VSIM_NV_NVDLA_MCIF_WRITE_IG_BPT_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vsim_NV_NVDLA_MCIF_WRITE_IG_bpt final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        CData/*0:0*/ u_dfifo0__DOT____VdfgRegularize_h287e8fcb_0_3;
        ...
        CData/*0:0*/ u_dfifo1__DOT____VdfgRegularize_h287e8fcb_0_3;
    ...
    // CONSTRUCTORS
    Vsim_NV_NVDLA_MCIF_WRITE_IG_bpt(Vsim__Syms* symsp, const char* v__name);
    ~Vsim_NV_NVDLA_MCIF_WRITE_IG_bpt();
    VL_UNCOPYABLE(Vsim_NV_NVDLA_MCIF_WRITE_IG_bpt);
