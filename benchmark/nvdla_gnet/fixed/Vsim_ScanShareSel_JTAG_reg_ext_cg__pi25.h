...
#ifndef VERILATED_VSIM_SCANSHARESEL_JTAG_REG_EXT_CG__PI25_H_
#define VERILATED_VSIM_SCANSHARESEL_JTAG_REG_EXT_CG__PI25_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vsim_ScanShareSel_JTAG_reg_ext_cg__pi25 final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vsim_ScanShareSel_JTAG_reg_ext_cg__pi25(Vsim__Syms* symsp, const char* v__name);
    ~Vsim_ScanShareSel_JTAG_reg_ext_cg__pi25();
    VL_UNCOPYABLE(Vsim_ScanShareSel_JTAG_reg_ext_cg__pi25);
