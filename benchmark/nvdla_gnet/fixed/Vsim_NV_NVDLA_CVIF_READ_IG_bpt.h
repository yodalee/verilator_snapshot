...
#ifndef VERILATED_VSIM_NV_NVDLA_CVIF_READ_IG_BPT_H_
#define VERILATED_VSIM_NV_NVDLA_CVIF_READ_IG_BPT_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vsim_NV_NVDLA_CVIF_READ_IG_bpt final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vsim_NV_NVDLA_CVIF_READ_IG_bpt(Vsim__Syms* symsp, const char* v__name);
    ~Vsim_NV_NVDLA_CVIF_READ_IG_bpt();
    VL_UNCOPYABLE(Vsim_NV_NVDLA_CVIF_READ_IG_bpt);
