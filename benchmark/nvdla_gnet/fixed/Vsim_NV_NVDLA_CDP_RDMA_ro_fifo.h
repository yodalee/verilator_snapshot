...
#ifndef VERILATED_VSIM_NV_NVDLA_CDP_RDMA_RO_FIFO_H_
#define VERILATED_VSIM_NV_NVDLA_CDP_RDMA_RO_FIFO_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vsim_NV_NVDLA_CDP_RDMA_ro_fifo final : public VerilatedModule {
  public:
    ...
    CData/*0:0*/ __VdfgRegularize_h7f565218_0_2;
    ...
    // CONSTRUCTORS
    Vsim_NV_NVDLA_CDP_RDMA_ro_fifo(Vsim__Syms* symsp, const char* v__name);
    ~Vsim_NV_NVDLA_CDP_RDMA_ro_fifo();
    VL_UNCOPYABLE(Vsim_NV_NVDLA_CDP_RDMA_ro_fifo);
